...
public class DayOfWeekInMonthRule extends AnnualDateRule {
    ...
    /** The day of the week (DayDate.MONDAY, DayDate.TUESDAY...). */
    private int dayOfWeek;

    /** The month (1 to 12, or DayDate.JANUARY, DayDate.FEBRUARY...). */
    private int month;
    ...
    public DayOfWeekInMonthRule() {
        this(1, DayDate.Day.MONDAY.index, MonthConstants.JANUARY);
    }
     ...
     * @param dayOfWeek  the day-of-the-week (DayDate.MONDAY, DayDate.TUESDAY, etc.).
     * @param month  the month (DayDate.JANUARY, DayDate.FEBRUARY, etc.).
     */
    ...
    /**
     * Returns the day-of-the-week for this rule (DayDate.MONDAY, DayDate.TUESDAY, etc.).
     *
