...
public class DayDateTest extends TestCase {
    ...
    public void testWeekdayCodeToString() {
        ...
        final String test = DayDate.weekdayCodeToString(DayDate.Day.SATURDAY);
        assertEquals("Samstag", test);
    ...
    public void testStringToWeekday() {
        ...
        int weekday = DayDate.stringToWeekdayCode("Mittwoch");
        assertEquals(DayDate.Day.WEDNESDAY.index, weekday);

        weekday = DayDate.stringToWeekdayCode(" Mittwoch ");
        assertEquals(DayDate.Day.WEDNESDAY.index, weekday);

        weekday = DayDate.stringToWeekdayCode("Mi");
        assertEquals(DayDate.Day.WEDNESDAY.index, weekday);
    ...
    public void testStringToMonthCode() {
        ...
        int m = DayDate.stringToMonthCode("Januar");
        assertEquals(MonthConstants.JANUARY, m);

        m = DayDate.stringToMonthCode(" Januar ");
        assertEquals(MonthConstants.JANUARY, m);
